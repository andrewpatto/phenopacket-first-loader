...
export type PfdlFile = Omit<org.phenopackets.schema.v2.core.File, "uri"> & {
  name: string;
  artifacts: { uris: string[]; size: number; checksums: Record<string, string> };
};

export type PfdlBiosample = Override<
...
export type PfdlIndividual = Override<
...
export type PfdlPhenopacket = Override<
  org.phenopackets.schema.v2.IPhenopacket,
  {
    // id?: string | null;
...
export type PfdlFamily = Override<
  org.phenopackets.schema.v2.IFamily,
  {
    // id?: string | null;
